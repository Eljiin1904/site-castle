    ...
    <ModalBody>
      <Div fx gap={12}>
        <ModalSection>
          ...
          <ModalCopyField text={query.data?.clientSeed} color="light-sand" textOverflow="ellipsis" />
        </ModalSection>
      </Div>
      <ModalSection justify="space-between">
        <ModalLabel>{t('seedModal.activeServerSeed')}</ModalLabel>
        <ModalCopyField text={query.data?.serverSeedHashed} color="light-sand" textOverflow="ellipsis"/>
      </ModalSection>
      <ModalSection>
        <ModalLabel>{t('seedModal.betsMadeWithPair')}</ModalLabel>
        <ModalCopyField text={Numbers.toLocaleString(query.data?.nonce || 0, 0)} color="light-sand" textOverflow="ellipsis" />
      </ModalSection>
      <Div
        fx
        borderBottom
      ...
      <ModalSection>
        ...
        <ModalCopyField text={query.data?.nextServerSeedHashed} color="light-sand" textOverflow="ellipsis" />
      </ModalSection>
      {historyTo && (
        <Fragment>
          <Div

...
export const CampaignIdField: FC<UsernameFieldProps> = ({
  placeholder,
  value,
  disabled,
  error,
  ...
  const query = useQuery({
    ...
    queryFn: () => Affiliates.checkCampaignId({ campaignId: currentValue! }),
        ...
        {query.isFetching ? (
          ...
          <Vector
            ...
            data-tooltip-content={
              isValid
                ? t("validations.campaign.campaignId.available")
                : currentValue
                  ? t("validations.campaign.campaignId.unavailable")
                  : t("validations.campaign.campaignId.required")
            }
          />
        )}
      </Div>

...
const GameLaunch = ({game_code, platform}: {game_code: string, platform: "GPL_DESKTOP" | "GPL_MOBILE"}) => {
  ...
  const gameLauncher = 'https://casino.nolimitcdn.com/loader/game-loader.html?game=TheBorder&operator=DAMA500K&language=en&lobbyUrl=https%3A%2F%2Fshock.com&device=desktop';//query.data || [];
  return (<Div fx>
    <iframe src={gameLauncher}

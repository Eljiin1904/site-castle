...
import { BlackjackFairnessInfoCard } from "./BlackjackFairnessInfoCard";
import { BlackjackFairnessHeader } from "./BlackjackFairnessHeader";
import { BlackjackFairnessTable } from "./BlackjackFairnessTable";
import { BlackjackFairnessFooter } from "./BlackjackFairnessFooter";

export const BlackjackFairnessBody = () => {
  const limit = 10;
  ...
  return (
    <Fragment>
      <BlackjackFairnessInfoCard />
      {authenticated ? (
        <Div
          fx
          column
        >
          <BlackjackFairnessHeader

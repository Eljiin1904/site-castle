...
export const FairnessPage = () => {
  ...
  return (<Fragment>
      <PageBanner image={`/graphics/fairness-tile`} heading={t(`title`)} description="" content={<></>}/> 
      <SitePage
        className="GamesPage"
        gap={small? 32: 56}
        pb={small? 40: 56}
...
const FairnessMenu = () => {
  ...
  return (<Conditional value={layout}
    ...
    tablet={<FairnessMenuDesktop items={items} layout={layout} />}
    laptop={<FairnessMenuDesktop items={items} layout={layout} />}
    desktop={<FairnessMenuDesktop items={items} layout={layout} />}
  />);
};

const FairnessMenuMobile = ({items}: {
...
const FairnessMenuDesktop = ({items, layout}: {
  items: { label: string; to: string, icon?:Svg }[];
    ...
    >
      <Div fx column  gap={small ? 32 : 56} alignItems="flex-start" position="relative" grow>
        <Routes>
          ...
          <Route
            path="/cases/game"
            element={<GameFairnessPage game="cases" caseKind={`case`} verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/cases/gem"
            element={<GameFairnessPage game="cases" caseKind={`gem-case`} verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/cases/level"
            element={<GameFairnessPage game="cases" caseKind={`level-case`} verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/cases"
            element={<GameFairnessPage game="cases" caseKind={`case`} verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          ...
          <Route
            path="/case-battles"
            element={<GameFairnessPage game="case-battles" verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/double"
            element={<GameFairnessPage game="double" verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/dice"
            element={<GameFairnessPage game="dice" verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/limbo"
            element={<GameFairnessPage game="limbo" verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/mines"
            element={<GameFairnessPage game="mines" verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/blackjack"
            element={<GameFairnessPage game="blackjack" verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="/crash"
            element={<GameFairnessPage game="crash" verificationLink="https://onecompiler.com/nodejs/42xmm7gm3" />}
          />
          <Route
            path="*"
            element={

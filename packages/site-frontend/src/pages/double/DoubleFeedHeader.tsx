...
export const DoubleFeedHeader = () => {
  ...
  return (
    ...
    >
      ...
      <BetHeaderColumn header={t('bets.headers.time')} flexBasis={0} grow={4} hideInMobile={true} />
      <BetHeaderColumn header={t('bets.headers.amount')} flexBasis={0} grow={4}  hideInMobile={true}/>
      <BetHeaderColumn header={t('bets.headers.multiplier')} flexBasis={0} grow={3} />

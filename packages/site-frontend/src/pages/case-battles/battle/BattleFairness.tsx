...
export const BattleFairness = () => {
  const serverSeed = useAppSelector((x) => x.battlePlayer.serverSeed);
  const serverSeedHash = useAppSelector(
    (x) => x.battlePlayer.serverSeedHash || "",
  );
  const eosBlockNum = useAppSelector((x) => x.battlePlayer.eosBlockNum || "");
  const eosBlockId = useAppSelector((x) => x.battlePlayer.eosBlockId || "");

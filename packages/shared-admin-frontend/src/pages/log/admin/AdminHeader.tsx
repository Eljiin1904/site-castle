...
export const AdminHeader = ({
  ...
  isLoading: boolean;
  setKind: (x: AdminLogKind | undefined) => void;
  ...
  return (
    ...
    >
      ...
      <Dropdown
        type="select"
        icon={SvgFilter}
        options={["All Kinds", ...Admin.logKinds].map(Strings.kebabToTitle)}
        value={kind ? Admin.logKinds.indexOf(kind) + 1 : 0}
        onChange={(x, i) =>
          setKind(i === 0 ? undefined : Admin.logKinds[i - 1])
        }
      />
      <Button

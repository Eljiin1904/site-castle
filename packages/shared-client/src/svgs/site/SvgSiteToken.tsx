...
export const SvgSiteToken = (props: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 16 16"
    fill="none"
    {...props}
  >
    ...
    <path
      fill="#D3780D"
      d="M7.507 1.817c-4.021.202-5.589 4.024-5.693 5.71.191-1.401 1.962-4.405 5.963-4.917 3.513-.45 5.812 2.956 6.411 4.718-.039-2.021-2.21-5.736-6.68-5.511Z"
    />
    <defs>
      <filter
        id="b"
      ...
      >
        ...
        <feBlend
          in2="shape"
          result="effect1_innerShadow_272_62605"
        />
      </filter>
    </defs>
  </svg>
